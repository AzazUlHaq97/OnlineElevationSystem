...
public partial class AdminPanel_Feedback : System.Web.UI.Page
{
    ...
    public void grid_binding()
    {
        ...
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from Feedback");
            cmd.Connection = con;
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        string SatisfyingLevel = ((TextBox)row.Cells[4].Controls[0]).Text;
        string Problem = ((TextBox)row.Cells[5].Controls[0]).Text;
        string Improvement = ((TextBox)row.Cells[6].Controls[0]).Text;
        ...
        cmd.CommandText = "UPDATE Feedback SET  [Name] = '" + Name + "'      ,[Email] = '" + Email + "'      ,[Description] ='" + Description + "'     ,[SatisfyingLevel] = '" + SatisfyingLevel + "'     ,[Problem] = '" + Problem + "'      ,[Improvement] = '" + Improvement + "'where [ID] ='" + id + "'";
